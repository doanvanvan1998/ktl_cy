...
function connect(){
    ...
    $a7="select distinct count(*) as total from university a where a.type_school = 'postgraduate' and degree = 1 group by a.type_school";
    ...
    $result = [$data1 == null ? "0" : $data1['total'],$data3== null ? "0" : $data3['total'],$data4== null ? "0" : $data4['total'],$data5== null ? "0" : $data5['total'],$data6== null ? "0" : $data6['total'],$data7== null ? "0" : $data7['total']];
