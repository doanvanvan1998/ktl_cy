...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="info">
        <span class="d-block" style='color:#fff'><?=$loggedUser['username']?> 관리자 <a href='#' onclick='onLogout()'>[ 로그아웃 ]</a></span>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
       ...
       <li class="nav-item" id='nav_4'>
        ...
        <li class="nav-item">
          <a href="http://localhost/ktl_cy/ktl/index.php" target="_blank" class="nav-link">
