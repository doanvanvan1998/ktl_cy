...
<div class='school_info_1_1'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          ...
          <input type="text" id='sch_1_data2' placeholder="학교명" class='college_txt2' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='sch_1_data3' placeholder="입학년월" required> -->
            <!-- <input type="text" id='sch_1_data4' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='sch_1_data8' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='sch_1_data9' placeholder="학점" required>
          <select id='sch_1_data10' onchange='onShoolCheck(1,1,8)'>
...
<div class='school_info_1_2' style='display:none;'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          ...
          <input type="text" id='sch_2_data2' placeholder="학교명" class='college_txt2' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='sch_2_data3' placeholder="입학년월" required> -->
            <!-- <input type="text" id='sch_2_data4' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='sch_2_data8' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='sch_2_data9' placeholder="학점" required>
          <select id='sch_2_data10' onchange='onShoolCheck(1,2,8)'>
            <option value="">총점</option>
            <option value="4.5">4.5</option>
            <option value="4.3">4.3</option>
            <option value="4.0">4.0</option>
...
<div class='school_info_1_3' style='display:none;'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          ...
          <input type="text" id='sch_3_data2' placeholder="학교명" class='college_txt2' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='sch_3_data3' placeholder="입학년월" required> -->
            <!-- <input type="text" id='sch_3_data4' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='sch_3_data8' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='sch_3_data9' placeholder="학점" required>
          <select id='sch_3_data10' onchange='onShoolCheck(1,3,8)'>
            <option value="">총점</option>
            <option value="4.5">4.5</option>
            <option value="4.3">4.3</option>
            <option value="4.0">4.0</option>
