...
<div class="flex-direction statement intro_1" style='margin-bottom:10px'>
  ...
  <div class="statement_info flex-direction" style='margin-top:10px;width:100%;'>
    <input type="text" id='intro_txt_1_1' placeholder="항목구분을 입력하시기 바랍니다." style='display:none;' required />
  </div>
  <div class="flex-direction">
    <textarea class="textcounbox" id='intro_txt_1_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)" maxlength="300"></textarea>
  </div>
</div>
...
<div class="flex-direction statement intro_2" style='margin-bottom:10px;display:none;'>
  ...
  <div class="statement_info flex-direction" style='margin-top:10px;width:100%;display:none;'>
    <input type="text" id='intro_txt_2_1' placeholder="항목구분을 입력하시기 바랍니다." style='display:none;' required />
  </div>
  <div class="flex-direction">
    <textarea class="textcounbox" id='intro_txt_2_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)"maxlength="300"></textarea>
  </div>
</div>
<div class="flex-direction statement intro_3" style='margin-bottom:10px;display:none;'>
  ...
  <div class="statement_info flex-direction" style='margin-top:10px;width:100%;'>
    <input type="text" id='intro_txt_3_1' placeholder="항목구분을 입력하시기 바랍니다." style='display:none;' required />
  </div>
  <div class="flex-direction">
    <textarea class="textcounbox" id='intro_txt_3_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)"maxlength="300"></textarea>
  </div>
</div>
