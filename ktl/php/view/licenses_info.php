...
<div class="flex certificate licenses_1" style='margin-bottom:10px;'>
  <input type="text" name='licenses_txt_1' id='licenses_txt_1' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_2' id='licenses_txt_2' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_3' id='licenses_txt_3' required>
...
<div class="flex certificate licenses_2" style='margin-bottom:10px;display:none;'>
  <input type="text" name='licenses_txt_4' id='licenses_txt_4' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_5' id='licenses_txt_5' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_6' id='licenses_txt_6' required>
    <div class="btn_plus mobile flex">
...
<div class="flex certificate licenses_3" style='margin-bottom:10px;display:none;'>
  <input type="text" name='licenses_txt_7'id='licenses_txt_7' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_8' id='licenses_txt_8' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_9' id='licenses_txt_9' required>
    <div class="btn_plus mobile flex">
...
<div class="flex certificate licenses_4" style='margin-bottom:10px;display:none;'>
  <input type="text" name='licenses_txt_10' id='licenses_txt_10' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_11' id='licenses_txt_11' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_12' id='licenses_txt_12' required>
    <div class="btn_plus mobile flex">
...
<div class="flex certificate licenses_5" style='margin-bottom:10px;display:none;'>
  <input type="text" name='licenses_txt_13' id='licenses_txt_13' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_14' id='licenses_txt_14' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_15' id='licenses_txt_15' required>
    <div class="btn_plus mobile flex">
...
<div class="flex certificate licenses_6" style='margin-bottom:10px;display:none;'>
  <input type="text" name='licenses_txt_16' id='licenses_txt_16' placeholder="자격증 명" class="search" required>
  <input type="text" name='licenses_txt_17' id='licenses_txt_17' placeholder="발행처" required>
  <div class="flex">
    <input type="date" name='licenses_txt_18' id='licenses_txt_18' required>
    <div class="btn_plus mobile flex">
