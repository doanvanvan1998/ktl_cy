...
<div class='school_info_2_1'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_1_data1' placeholder="학교명" class='college_txt' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='grad_1_data2' placeholder="입학년월" required> -->
            <!-- <input type="text" id='grad_1_data3' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_1_data7' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='grad_1_data8' placeholder="학점" required>
...
<div class='school_info_2_2' style='display:none;'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_2_data1' placeholder="학교명" class='college_txt' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='grad_2_data2' placeholder="입학년월" required> -->
            <!-- <input type="text" id='grad_2_data3' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_2_data7' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='grad_2_data8' placeholder="학점" required>
...
<div class='school_info_2_3' style='display:none;'>
  <div class="flex-direction sub_all_form">
    <div class="flex scformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_3_data1' placeholder="학교명" class='college_txt' required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <div class="flex">
            <!-- <input type="text" id='grad_3_data2' placeholder="입학년월" required> -->
            <!-- <input type="text" id='grad_3_data3' placeholder="졸업년월" required> -->
    ...
    <div class="flex scformbox subformbox">
      <div class="schoolbox">
        <div class="flex">
          <input type="text" id='grad_3_data7' placeholder="전공명" required>
        </div>
      </div>
      <div class="graduate">
        <div class="flex">
          <input type="text" id='grad_3_data8' placeholder="학점" required>
