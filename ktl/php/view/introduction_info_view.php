...
<div class="flex-direction statement intro_1" style='margin-bottom:10px'>
  <div class="flex">
    <select disabled style='color:#000'  id='intro_sel_1'>
      <option>성장과정</option>
      <option>지원동기</option>
  ...
  <div class="flex-direction">
    <textarea disabled style='color:#000'  class="textcounbox" id='intro_txt_1_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)"><?=$intro_txt_1_2?></textarea>
  </div>
</div>

<div class="flex-direction statement intro_2" style='margin-bottom:10px;display:none;'>
  <div class="flex">
    <select disabled style='color:#000'  id='intro_sel_2'>
      <option>성장과정</option>
      <option>지원동기</option>
      <option>성격의 장단점</option>
      <option>입사 후 포부</option>
  ...
  <div class="flex-direction">
    <textarea disabled style='color:#000'  class="textcounbox" id='intro_txt_2_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)"><?=$intro_txt_2_2?></textarea>
  </div>
</div>
<div class="flex-direction statement intro_3" style='margin-bottom:10px;display:none;'>
  <div class="flex">
    <select disabled style='color:#000'  id='intro_sel_3'>
      <option>성장과정</option>
      <option>지원동기</option>
      <option>성격의 장단점</option>
      <option>입사 후 포부</option>
  ...
  <div class="flex-direction">
    <textarea disabled style='color:#000'  class="textcounbox" id='intro_txt_3_2' placeholder="내용 작성 (최소 50자 이상, 최대 300자 이내)"><?=$intro_txt_3_2?></textarea>
  </div>
</div>
