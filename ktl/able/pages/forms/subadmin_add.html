        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">면접관등록</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">면접관 기본정보</h3>
            </div>
            <div class="card-body">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="email" id="useremail" class="form-control" placeholder="이메일주소를 입력하세요.">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
...
<script>
  ...
  $("#nav_2").attr("class","nav-item menu-is-opening menu-open");
  $("#nav_2_1").attr("class","nav-link active");
</script>
</body>
</html>
