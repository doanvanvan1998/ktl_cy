      ...
      <div class="container">
        ...
        <script>
          ...
          function onUserCheck()
          {
            ...
            else if($("#userphone").val() == "") { alert("연락처를 입력하시기 바랍니다."); $("#userphone").focus(); return;}
          ...
          <div class="answer" style='margin-top:50px;'>
            ...
            <div class="write_form flex-direction">
              <div class="flex">
                ...
                <div class="form_con">
                  <textarea id='objection_answer_contents' style='border:0;overflow:auto;font-size:16px;background-color:transparent;width:100%;height:100px;' readonly>
      DB에서 가져오는중...
                  </textarea>
                </div>
              </div>
...
<script>
  ...
  {
    if(!$('#chk1').is(':checked')) { alert("개인정보제공 동의 부분에 체크해주시기 바랍니다."); return;}

    if($("#objection_type").val() == 0) { alert("문의형태를 선택하세요."); return;}
    else if($("#objection_username").val() == "") { alert("이름을 입력하세요."); $("#objection_username").focus(); return;}
    else if($("#objection_phone").val() == "") { alert("연락처를 입력하세요."); $("#objection_phone").focus(); return;}
    else if($("#objection_email").val() == ""){ alert("이메일을 입력하세요."); $("#objection_email").focus(); return;}
    else if($("#objection_subject").val() == ""){ alert("제목을 입력하세요."); $("#objection_subject").focus(); return;}
    else if($("#objection_contents").val() == ""){ alert("내용을 입력하세요."); $("#objection_contents").focus(); return;}
