        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <?php
              ...
              $nIndex = 1;
              $query="select id,subject,contents,date from recruit_able_notice where id='$Id'";
            ...
            <div class="card-body">
              ...
              <button onclick='onEdit()' class='btn btn-primary'>수정하기</button>
            </div>
          </div>
        </div>
        <!-- /.col-->
