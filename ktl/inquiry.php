            ...
            <div class="list formbase">
                ...
                <table class="table">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if ($row[5] == 0)
                            echo "  <a href='../ktl/unlock.php?id=$row[0]'>
  <img src='images/icons/ic_lock.png' alt='잠금' style='width: 1rem; height: 1rem; margin-left: 0.2rem; display: flex; justify-content: center; align-items: center'>
</a>  
  </td>";
                        echo "<td>" . $row[3] . "**</td>
                                      <td>$row[4]</td>";
                ...
                <div class="table">
                    ...
                    <div class="pager flex">
                        <div class="btn_prev btn flex"><span class="hide">이전</span><img
                                    src="images/btns/btn_pager_prev.png"
                                    alt="이전"></div>
                        <div class="pagernum flex">
                            <span class="on">1</span>
                        </div>
                        <div class="btn_next btn flex"><span class="hide">다음</span><img
                                    src="images/btns/btn_pager_next.png"
                                    alt="다음"></div>
                    </div>
