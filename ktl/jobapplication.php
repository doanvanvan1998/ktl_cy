      ...
      <div class="container">
        ...
        <div class="forms">
            ...
            <div class="form_con">
              <div class="flex-direction inputbox">
                <div class="phone flex">
                  <input type="text" id='userphone' maxlength="3" required numberOnly>
                  <span class="linebar"></span>
                  <input type="text" id='userphone2' maxlength="4" required numberOnly>
                  <span class="linebar"></span>
                  <input type="text" id='userphone3' maxlength="4" required numberOnly>
                </div>
          ...
          <div class="flex baseline">
            ...
            <div class="form_con">
              <div class="flex-direction inputbox">
                <input type="password" id='userpass' placeholder="비밀번호를 입력해주세요." required onkeyup="checkPassword(this.value);">
                <input type="password" id='userpass_check' placeholder="비밀번호 확인을 위해 다시 한번 입력해주세요." required>
                <span class="noti"><span>*</span> <span class="textlength">10자 이상</span> <span class="texteng">영문</span>/<span class="textnumber">숫자</span>/<span class="textspecial">특수문자</span>를 반드시 포함하여 입력해주세요.</span>
              </div>
            </div>
          </div>
          <div class="flex">
